...
local Library = {
    ...
    TweenInfo = TweenInfo.new(0.2, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), -- Snappier Animations
    NotifyTweenInfo = TweenInfo.new(0.3, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), -- Smoother Notify
    ...
    DPIScale = 1,
    CornerRadius = 6, -- Softened corners

    IsLightTheme = false,
    --// NEW DESIGN SCHEME \\--
    Scheme = {
        BackgroundColor = Color3.fromRGB(18, 18, 24),    -- Deep Midnight Blue/Grey
        MainColor = Color3.fromRGB(28, 28, 36),          -- Lighter Midnight for containers
        AccentColor = Color3.fromRGB(60, 160, 255),      -- Vibrant Cyan/Blue Accent
        OutlineColor = Color3.fromRGB(45, 45, 55),       -- Subtle border
        FontColor = Color3.fromRGB(240, 240, 245),       -- Clean White Text
        Font = Font.fromEnum(Enum.Font.GothamMedium),    -- Modern Font
...
local Templates = {
    ...
    Window = {
        ...
        NotifySide = "Right",
        ShowCustomCursor = true,
        Font = Enum.Font.GothamMedium, -- Updated Default
        ToggleKeybind = Enum.KeyCode.RightControl,
...
function Library:MakeOutline(Frame: GuiObject, Corner: number?, ZIndex: number?)
    ...
    -- Design Upgrade: Add UIStroke for cleaner borders
    New("UIStroke", {
        Color = "OutlineColor",
        Thickness = 1,
        Transparency = 0,
...
do
    ...
    function Funcs:AddToggle(Idx, Info)
        ...
        local Switch = New("Frame", {
            ...
            Size = UDim2.fromOffset(36, 18), -- Slightly wider for modern look
            Parent = Button,
        })
        New("UICorner", {
            CornerRadius = UDim.new(1, 0),
