...
-- Все награды рулетки
local AllRouletteRewards = {
	-- Денежные награды
	{type = "Money", value = 5000, chance = 0.45},
	{type = "Money", value = 30000, chance = 0.3},
	
	-- Питомцы
	{type = "Pet", name = "Galactic Paladin", rarity = "Exclusive", chance = 0.003},
	{type = "Pet", name = "Mythic Gem Shock", rarity = "Mythic", chance = 0.005},
	{type = "Pet", name = "Mythic King Slime", rarity = "Mythic", chance = 0.005},
	{type = "Pet", name = "Mythic Radiant One", rarity = "Mythic", chance = 0.005},
	{type = "Pet", name = "Mythic Vectorlord", rarity = "Mythic", chance = 0.005},
	{type = "Pet", name = "Mythic Autumnal Master", rarity = "Mythic", chance = 0.005},
	
	-- Зелья
	{type = "Potion", name = "ChewingPower", chance = 0.097},
	{type = "Potion", name = "Money", chance = 0.15}
}

-- Все питомцы из ReplicatedStorage
-- Все питомцы из ReplicatedStorage
local AllPets = {
	"Abyss",
	"Glacier",
	...
	"Magma Butterfly",
	"Matrix Robot",
	"Mega Fairy Chihuahua",
	"Mega King Ant",
	"Mega Lily",
	"Mega Sinister Pumpkin",
	"Mega Soul Golem",
	"Minty Serpent",
	...
	"Topaz Soul",
	"Mythic Luminance",
	"Brown Bear", -- DisplayName для Dragon
	"Mystic Doggy", -- DisplayName для Golden Hybrid
	"Hacked Alien Hydra", -- DisplayName для Mythic Vectorlord
	"Cat", -- DisplayName для Yellow Dino
	"Saturn Doggy", -- DisplayName для Fancy Dragon
	"Dark Hydra", -- DisplayName для Lucky Wyvern
	"Bat", -- DisplayName для Summer Shark
	"Electro", -- DisplayName для Water Crab
	"Golem Hydra", -- DisplayName для Neon Sky Bunny
	"Chicken", -- DisplayName для Rubber Kitty
	"Cyber Robot", -- DisplayName для Space Bull
	"Party Hydra", -- DisplayName для Lightning Demon
	"Brown Chihuahua", -- DisplayName для Rubber Bunny
	"Acid Rain Dragon", -- DisplayName для Fire Deer
	"Ruby Spider", -- DisplayName для Golden Butterfly
	"Cerulean Hydra", -- DisplayName для Minty Serpent
	"Chocolate Cake", -- DisplayName для Magma Butterfly
	"Matrix Kitty", -- DisplayName для Lucky Fiend
	"Witches Cat", -- DisplayName для Slime Overlord
	"Lunar Lighthawk", -- DisplayName для Ruby Bat
	"Ruby Golem", -- DisplayName для Rubber Deer
	"Black Alien Hydra", -- DisplayName для Unicorn
	"Sapphire Dragon", -- DisplayName для Starry Demon
	"Mega Galaxy Doggy", -- DisplayName для Spore Serpent
	"Lava Lamb", -- DisplayName для Night Terror
	"Flamethrower", -- DisplayName для Light Demon
	"Mega Demon", -- DisplayName для Phoenix Hybrid
	"Mega Amythest Dragon", -- DisplayName для Wolflord
	"Heart Leviathan", -- DisplayName для Plasma Wolflord
	"Mega Alien", -- DisplayName для Mythic King Slime
	"Ultra Alien", -- DisplayName для Mythic Gem Shock
	"Crab", -- DisplayName для Lava Fox
	"Pufferfish", -- DisplayName для Sky Imp
	"Fairy Chihuahua", -- DisplayName для Mythic Autumnal Master
	"Mystic Kitsune", -- DisplayName для Galactic Paladin
	"Golden Ant", -- DisplayName для Gold Ant
	"Pet" -- Общее имя для некоторых питомцев
}
...
do
	...
	Tab:Section({Name = "Pets Management"})
	
	Tab:Button({
		Name = "Get ALL Pets from Roulette",
		Description = "Claim all available pets through roulette system",
		Action = function()
			print("Claiming all pets from roulette...")
			...
			for _, petName in ipairs(AllPets) do
				...
				print("Pet Claimed: " .. petName)
				wait(0.05)
			end
			
			print("All pets claimed!")
		end,
	})
	
	Tab:Button({
	Name = "Get Mythic Pets",
	Description = "Claim all Mythic rarity pets",
	Action = function()
		local mythicPets = {
			"Mythic Gem Shock",
			"Mythic King Slime", 
		...
		for _, petName in ipairs(mythicPets) do
			RouletteEvent:FireServer({
				type = "Pet",
				name = petName,
				rarity = "Mythic",
			...
			print("Mythic Pet Claimed: " .. petName)
			wait(0.1)
		end
	end,
})
	...
	Tab:Button({
	Name = "Get Exclusive Pets",
	Description = "Claim exclusive pets like Galactic Paladin",
	Action = function()
		local exclusivePets = {
			"Galactic Paladin",
			"Dark Lord",
		...
		for _, petName in ipairs(exclusivePets) do
			RouletteEvent:FireServer({
				type = "Pet",
				name = petName,
				rarity = "Exclusive",
			...
			print("Exclusive Pet Claimed: " .. petName)
			wait(0.1)
		end
	end,
})
